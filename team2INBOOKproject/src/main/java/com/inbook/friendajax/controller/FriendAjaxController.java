package com.inbook.friendajax.controller;
...
public class FriendAjaxController implements Controller {
...
//			System.out.println("아이디 : "+id);
			int log = 0;
			request.setAttribute("cnt", Execute.service(friendRequestCountService, id));
