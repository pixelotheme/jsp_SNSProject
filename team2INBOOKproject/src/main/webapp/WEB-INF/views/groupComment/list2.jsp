...
$(document).ready(function() {
	...
	$(".commentDeleteBtn").click(function(){
		...
		if(confirm("댓글을 삭제하시겠습니까?")) {
			$("#commentForm").attr("action","/groupComment/groupCommentDelete.do");
			$("#commentForm").submit();
		}
	});
	...
	$("#commentWriteBtn").click(function(){
		...
		// form 데이터 전송 URL 설정
		$("#commentForm").attr("action", "/groupComment/groupCommentWrite.do");
		$("#commentForm").submit();
	});
	...
	$("#commentUpdateBtn").click(function(){
		...
		// form 데이터 전송 URL 설정
		$("#commentForm").attr("action", "/groupComment/groupCommentUpdate.do");
		$("#commentForm").submit();
	});
