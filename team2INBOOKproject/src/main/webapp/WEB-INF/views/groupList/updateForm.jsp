...
<%@page import="com.inbook.groupList.vo.GroupListVO"%>
<%@page import="com.inbook.groupList.service.GroupListViewService"%>

<%@ page language="java" contentType="text/html; charset=UTF-8" errorPage="/error/groupListWriteError.jsp"
    pageEncoding="UTF-8"%>
